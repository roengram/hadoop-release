...
function Main( $scriptDir )
{
    ...
    $yarnConfigs =@{
        ...
        "yarn.resourcemanager.webapp.address.rm1" = "${ENV:RESOURCEMANAGER_HOST}:8088".ToLower();
        "yarn.resourcemanager.webapp.https.address.rm1" = "${ENV:RESOURCEMANAGER_HOST}:8088".ToLower();
        "yarn.resourcemanager.webapp.address.rm2" = "${ENV:RESOURCEMANAGER_HOST}:8088".ToLower();
        "yarn.resourcemanager.webapp.https.address.rm2" = "${ENV:RESOURCEMANAGER_HOST}:8088".ToLower();
