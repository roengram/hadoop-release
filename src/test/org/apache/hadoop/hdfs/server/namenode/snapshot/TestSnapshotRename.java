...
public class TestSnapshotRename {
  ...
  public void testSnapshotRename() throws Exception {
    ...
    for(PropertyDescriptor propertyDescriptor : 
      Introspector.getBeanInfo(FileStatus.class).getPropertyDescriptors()) {
      Method getter = propertyDescriptor.getReadMethod();
      if (getter != null && !getter.getName().contains("getPath")) {
        System.out.println(getter.getName());
        String valueBefore = getter.invoke(statusBeforeRename).toString();
        String valueAfter = getter.invoke(statusAfterRename).toString();
