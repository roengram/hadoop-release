  ...
  public void testRenameFromSDir2NonSDir() throws Exception {
    ...
    try {
      ...
      assertTrue(e.getMessage().contains(
          abcStr + " is snapshottable and already has snapshots"));
    }
...
//    // modification on /dir2/foo
  ...
  public void testRenameAndUpdateSnapshottableDirs() throws Exception {
    ...
    SnapshotTestHelper.createSnapshot(hdfs, foo, snap1);
    assertEquals(1, fsn.getSnapshottableDirListing().length);
    ...
    try {
      ...
      assertTrue(e.getMessage().contains(
          foo.toString() + " is snapshottable and already has snapshots"));
    }
    
    hdfs.deleteSnapshot(foo, snap1);
    hdfs.rename(foo, bar);
