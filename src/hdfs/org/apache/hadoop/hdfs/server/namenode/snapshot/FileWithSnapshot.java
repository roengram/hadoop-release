...
public interface FileWithSnapshot {
  ...
  static class FileDiffFactory extends
      AbstractINodeDiff.Factory<INodeFile, FileDiff> {
   ...
   */
  public static class FileDiffList extends
      AbstractINodeDiffList<INodeFile, FileDiff> {
  }
