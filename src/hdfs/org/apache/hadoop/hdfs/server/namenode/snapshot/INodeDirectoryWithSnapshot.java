...
public class INodeDirectoryWithSnapshot extends INodeDirectoryWithQuota {
  ...
  public INodeDirectoryWithSnapshot saveSelf2Snapshot(final Snapshot latest,
      final INodeDirectory snapshotCopy) throws QuotaExceededException {
  ...
  public void replaceRemovedChild(INode oldChild, INode newChild) {
    ...
    boolean replace = diffs.replaceChild(ListType.DELETED, oldChild, newChild);
    if (!replace) {
