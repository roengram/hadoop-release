...
public class Nfs3Status {
   ...
   */
  public static int NFS3ERR_ACCES = 13;
  
  /** File exists. The file specified already exists. */
  public static int NFS3ERR_EXIST = 17;
  
  /** Attempt to do a cross-device hard link. */
  public static int NFS3ERR_XDEV = 18;
  
  /** No such device. */
  public static int NFS3ERR_NODEV = 19;
  ...
  public static int NFS3ERR_ISDIR = 21;
   ...
   */
  public static int NFS3ERR_STALE = 70;
  
  /**
   * The file handle given in the arguments referred to a file on a non-local
   * file system on the server.
   */
  public static int NFS3ERR_REMOTE = 71;
  
  /** The file handle failed internal consistency checks */
  public static int NFS3ERR_BADHANDLE = 10001;
  
  /**
   * Update synchronization mismatch was detected during a SETATTR operation.
   */
  public static int NFS3ERR_NOT_SYNC = 10002;
  
  /** READDIR or READDIRPLUS cookie is stale */
  public static int NFS3ERR_BAD_COOKIE = 10003;
  
  /** Operation is not supported */
  public static int NFS3ERR_NOTSUPP = 10004;
  
  /** Buffer or request is too small */
  public static int NFS3ERR_TOOSMALL = 10005;
   ...
   */
  public static int NFS3ERR_SERVERFAULT = 10006;
  
  /**
   * An attempt was made to create an object of a type not supported by the
   * server.
   */
  public static int NFS3ERR_BADTYPE = 10007;
   ...
   */
  public static int NFS3ERR_JUKEBOX = 10008;
}
