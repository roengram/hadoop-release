  ...
  protected void render(Block html) {
    ...
    info("Application Metrics")
        ._("Total Resource Preempted:",
            String.format("memory=%d, vcores=%d", appMerics
                .getResourcePreempted().getMemory(), appMerics
                .getResourcePreempted().getVirtualCores()))
        ...
        ._("Resource Preempted from Current Attempt:",
            String.format("memory=%d, vcores=%d", attemptMetrics
                .getResourcePreempted().getMemory(), attemptMetrics
                .getResourcePreempted().getVirtualCores()))
